class SaveObjects:
    ...
    def save(self,thing):
        ...
        assert hasattr(thing,method),f"Unknown object type {typename}"
...
class LoadObjects:
    ...
    def load_str(self,value):
        return '\n'.join(
            [self.reader.readline()[:-1] for _ in range(len(value))]
        )
